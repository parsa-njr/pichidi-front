...
export default function SelectField({
    ...
    return (
        <div className="mb-4" dir="rtl">
            <label className="block text-xs text-gray-500 text-right mb-1.5">
                {label}
            </label>
            <Select value={value || undefined} onValueChange={onChange}>
                <SelectTrigger  className="w-full bg-gray-50 border-gray-200 rounded-xl px-4 py-3 h-auto text-right text-sm text-gray-800">
