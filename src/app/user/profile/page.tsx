...
import { useUserProfile, useUpdateUserProfile } from "@/api/user/profile/queries";
    ...
    <div dir="rtl" className="flex flex-col min-h-full bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 pb-24">
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-sm font-semibold text-gray-700 mt-3">{name}</p>
          <p className="text-xs text-gray-400 mt-1">روی آیکون دوربین کلیک کنید تا عکس را تغییر دهید</p>
        </div>
